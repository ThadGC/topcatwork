 ...
 */
/**
 * `#cineTrust` — the two chips that ride the hero film's wide-band wipe,
 * alongside the film's own opening line.
 *
 * ⛔ RESTORED 28 Aug 2026. They were dropped with the film and not put back
 * with it, and the client caught it against the old site: the opening frame
 * should carry "Google reviews 5.0" and "10 year guarantee" at the bottom left,
 * sliding out to the left with the copy.
 *
 * NOT the same block as `.hero-chips` below, and the differences are
 ...
 * film's own `.trust` wrapper hides the whole subtree, so repeating it here
 * would be noise.
 */
