...
export const SITEMAP_GROUPS: readonly SitemapGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/services/kitchen-islands', label: 'Kitchen islands and waterfall ends' },
      { href: '/services/splashbacks', label: 'Splashbacks and upstands' },
      { href: '/services/bathroom-worktops', label: 'Bathroom worktops and shower surrounds' },
      { href: '/services/vanity-tops', label: 'Stone vanity tops' },
      { href: '/services/outdoor-kitchens', label: 'Outdoor kitchen worktops' },
      { href: '/services/fireplaces', label: 'Fireplace surrounds, hearths and mantels' },
      { href: '/services/dining-tables', label: 'Stone dining tables' },
      { href: '/services/commercial-worktops', label: 'Commercial stone surfaces' },
    ],
  },
  {
    title: 'Materials',
