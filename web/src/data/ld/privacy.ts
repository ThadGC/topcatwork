/* ==========================================================================
   The structured data on /privacy/, lifted verbatim out of privacy/index.html.
...
export const PRIVACY_LD: readonly unknown[] = [
  [
    {
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Privacy Policy",
          "item": "https://www.topcatworktops.co.uk/privacy/"
        }
      ]
    }
  ]
