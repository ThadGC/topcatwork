/* ==========================================================================
   The structured data on /sitemap.html, lifted verbatim out of sitemap.html.
...
export const SITEMAP_LD: readonly unknown[] = [
  [
    {
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Sitemap",
          "item": "https://www.topcatworktops.co.uk/sitemap.html"
        }
      ]
    }
  ]
