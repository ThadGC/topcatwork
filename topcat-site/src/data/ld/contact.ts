/* ==========================================================================
   The structured data on /contact/, lifted verbatim out of contact/index.html.
...
export const CONTACT_LD: readonly unknown[] = [
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Contact",
        "item": "https://www.topcatworktops.co.uk/contact/"
      }
    ]
  }
];
