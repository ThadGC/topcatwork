...
> ⛔ **SUPERSEDED — this is no longer the START HERE.** It was replaced on 18 Aug 2026 by
> `HANDOVER-NEXT-CHAT-START-HERE.md` (D315–D318: the clean-out, the film's copy, the dead
> scroll, and site speed as a standing rule). ⚠️ **Its delivery figures, `--cineH`/`--cineHold`
> values and freeze-probe numbers below are STALE** — the current ones are in that file.
> Kept because §2–§4 explain how the film was built and why.
>
