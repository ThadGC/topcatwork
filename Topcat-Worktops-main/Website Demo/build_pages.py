...
# ⭐⭐ THE TWO @font-face RULES, SELF-HOSTED (D443). Written into nav.css and footer.css
# because those are the only sheets on ALL 171 generated pages — only 6 of the 178 load
# site.css, where the landing page's own copy lives.
# ⛔ THEY CANNOT BE LIFTED OUT OF index.html's <style> BY `_nav_css`/`_footer_css`: those
# helpers select by SELECTOR TEXT, and `@font-face` is an at-rule with no selector to match, so
# it would be dropped in silence and the whole site would fall back to Times while the source
# looked perfectly correct.
# ⚠️ Keep byte-identical to the pair in index.html's <style>. The faces are VARIABLE, so one
# file per family covers every weight the site asks for (Cinzel 400-600, Montserrat 300-600).
_FONT_FACE = (
    "@font-face{font-family:'Cinzel';font-style:normal;font-weight:400 600;font-display:swap;src:url(/assets/fonts/cinzel-latin-var.woff2) format('woff2');unicode-range:U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD}@font-face{font-family:'Montserrat';font-style:normal;font-weight:300 600;font-display:swap;src:url(/assets/fonts/montserrat-latin-var.woff2) format('woff2');unicode-range:U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD}\n"
)
