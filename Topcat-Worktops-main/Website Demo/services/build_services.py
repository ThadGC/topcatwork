...
<main>
  ...
  <section class="block"><div class="wrap rise">
    ...
    <!-- ⛔⛔ **"granite, with porcelain" READ AS A PROPERTY OF THE GRANITE — client, 25 Aug 2026.**
         His correction, verbatim in his own construction: *"You can't say marble, quartz and
         granite with porcelain, because that makes it sound like granite has porcelain in it. So
         marble, quartz, granite and porcelain. That's how you put it."*
         ⭐ **HE IS RIGHT ABOUT THE GRAMMAR AND IT IS WORTH KEEPING WHY.** A trailing "with X" phrase
         attaches to the nearest noun, so appending porcelain that way modified "granite" instead of
         extending the list. Porcelain is simply the fourth item now.
         ⚠️ **"with more available on request" STAYS AND STILL SCANS**, because "more" means further
         materials beyond the four named, not a qualifier on porcelain.
         ⚠️ The on-request qualifier porcelain genuinely needs (§2 rule 8 — enquiry-led, no supplied
         range) lives on the pill itself, which is where he put it: *"you can just state that
         porcelain is upon request."* ⛔ Do not fold it back into this sentence. -->
    <p class="sub">Marble, quartz, granite and porcelain, with more available on request. Not sure what suits you? We will tell you the truth, not just what is easiest to sell.</p>
